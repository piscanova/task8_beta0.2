...
public class FundPriceDAO extends GenericDAO<FundPriceBean> {
	...
	public FundPriceDAO(ConnectionPool cp, String tableName)
			throws DAOException {
		...
		if (fundPrices == null) {
			...
			Arrays.sort(fundPrices, new Comparator<FundPriceBean>() {
				...
				public int compare(FundPriceBean o1, FundPriceBean o2) {
					return Util.compareDateStrings(o1.getPriceDate(),
							o2.getPriceDate());
				}
			});
			return fundPrices;
	...
	public FundPriceBean getCurrentFundPrice(int fundId)
